...
from .routers import users_router, orders_router, cost_splitting_router, accommodation_router
...
api_router.include_router(accommodation_router, prefix="/accommodation", tags=["Accommodation API"])