...
from .models import BaseModel, SupermarketProducts, Users, Orders, Accommodation
from .models import hardcoded_products, hardcoded_users, hardcoded_orders, hardcoded_accommodations
